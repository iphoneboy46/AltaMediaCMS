      ...
      <div className="p-[10px] bg-[#E5E5E5]">
        <div className="flex items-center">
          ...
          <div className="relative">
            ...
            <i className="fa-solid fa-magnifying-glass absolute top-[50%] right-0 translate-y-[-50%] px-5 py-2 bg-[#faeded] ease-linear duration-200 rounded-tr-md hover:bg-[#FFB800]"></i>
          </div>
        </div>
      </div>
    </div>
