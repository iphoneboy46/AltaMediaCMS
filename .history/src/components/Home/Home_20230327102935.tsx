  ...
  return (
    <div className="w-[80%] bg-[white] p-10 absolute top-20 left-[15%] h-[100vh]">
        ...
        <div className="flex items-center justify-between mt-[50px] mb-[20px]">
           ...
           <div>
             <input className="p-2 outline-none" type="date" value="2023-04-27" />
           </div>
        </div>
        <Charts />
        ...
        <div className="flex items-start p-10 justify-between relative">
          <div className="flex-1">
            <input type="date" value="2023-04-27" />
          </div>
          <div className="flex-1">
            <PieChart />
          </div>
          ...
          <div className="flex-1 relative h-[200px]">
              <div className="absolute top-[10%] right-0">
                ...
                <div className="flex items-center">
                  <span className="block w-[50px] h-[20px] bg-[#FF8A48] mr-2"></span> <h2 className="text-[14px] font-[400]">Vé chưa sử dụng</h2>
                </div>
              </div>
          </div>
        </div>
